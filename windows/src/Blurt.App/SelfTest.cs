...
public static class SelfTest
{
    ...
    private static int CheckStorage()
    {
        ...
        var directory = Path.Combine(Path.GetTempPath(), $"blurt-selftest-{Guid.NewGuid():N}");
    ...
    /// </summary>
    /// <remarks>
    /// This is the riskiest thing in the app's structure. <c>Blurt.App</c> targets plain
    /// <c>net10.0</c> and loads <c>Blurt.Platform.Windows</c> by reflection, which is what
