...
/// <remarks>
/// <para>
/// <b>Why reflection rather than a project reference:</b> <c>Blurt.Platform.Windows</c>
...
{
    private const string AssemblyName = "Blurt.Platform.Windows";
    private const string Namespace = "Blurt.Platform.Windows";
    ...
    /// one is deliberately invisible to it — that is what keeps <c>Blurt.App</c> on plain
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "Blurt.Platform.Windows ships whole beside the executable and is "
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "Blurt.Platform.Windows is published whole and never trimmed.")]
