...
using Blurt.App.Controls;
using Blurt.App.Design;
using Blurt.App.Views;
using Shouldly;

[assembly: AvaloniaTestApplication(typeof(Blurt.AppTests.TestAppBuilder))]

namespace Blurt.AppTests;
